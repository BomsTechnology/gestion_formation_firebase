...
const { loading, createTraining, errors, cleanErrors } = useTrainings();
...
const storeTraining = async () => {
  await createTraining({ ...training });
};
const handelImage = () => {
  training.image = file.value.files[0];
};
</script>
...
<template>
  <div class="p-8 h-full">
    ...
    <div class="mt-10 lg:p-10 p-4 bg-white">
      ...
      <form @submit.prevent="storeTraining()">
