...
<template>
  ...
  >
    <div class="flex justify-between">
      <h1 class="font-bold text-4xl">Teachers</h1>
      <router-link
    ...
    <table class="w-full text-left text-sm text-gray-500 shadow">
      <thead class="bg-gray-50 text-xs uppercase text-gray-700">
        <tr>
          ...
          <th scope="col" class="px-6 py-3">Enter Date</th>
      ...
      <tbody>
        ...
        >
          ...
          <td class="px-6 py-4">
            {{
              teacher.diploma.lenght > 24
                ? teacher.diploma.substring(0, 24) + "..."
                : teacher.diploma
            }}
          </td>
          <td class="px-6 py-4">
            {{
              new Date(teacher.enterDate).toLocaleDateString("fr-FR", {
                year: "numeric",
                month: "long",
              })
            }}
          ...
          <td class="px-6 py-4 text-right">
            <router-link
              :to="{ name: 'admin.teacher.edit', params: { id: teacher.id } }"
